				...
				<?php while( have_rows('solucoes') ): the_row(); 
					...
					<article class="col-12 col-sm-6 col-md-4 col-lg-3">
						...
						<div class="card-solucao-meta">
							...
							<a class="linkSolucaoInfo" rel="<?php echo $linkRelInfo; ?>" href="<?php echo $linkSolucaoInfo['url']; ?>" title="<?php echo $linkSolucaoInfo['title']; ?>" target="<?php echo $linkSolucaoInfo['target']; ?>">
								<button>
